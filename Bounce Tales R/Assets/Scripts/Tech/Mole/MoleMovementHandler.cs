...
public class MoleMovementHandler : MonoBehaviour {
    ...
    private void MoveHead(Vector2 finalPos) {
        MolesHead.transform.localPosition = Vector2.Lerp(MolesHead.transform.localPosition,
                                                         finalPos, Time.deltaTime * HeadMoveSpeed);
    }
    ...
    public void LaunchHead() {
        if (!isHeadLaunched)  // added condition
        {
            ...
            MolesHead.transform.localPosition = new Vector2(
                MolesHead.transform.localPosition.x, MolesHead.transform.localPosition.y + 4f);
